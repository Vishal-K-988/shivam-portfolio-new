...
import { 
  ...
  SiX, SiDiscord, SiSteam, SiFigma, SiWebflow
} from 'react-icons/si';
...
const Portfolio = () => {
  ...
  const theme = {
    ...
    dock: isDark ? "bg-[#111]/80 border-gray-800" : "bg-white/80 border-gray-200",
  ...
  return (
    <motion.div 
      ...
      className="h-screen w-screen overflow-hidden relative flex flex-col items-center justify-center selection:bg-green-200 selection:text-green-900"
    >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        className={`fixed top-8 left-8 z-50 p-3 rounded-full ${isDark ? "bg-gray-800 text-white" : "bg-white text-black shadow-sm border border-gray-200"} transition-all duration-300`}
      >
      ...
      <div className={`fixed top-8 right-8 z-50 flex items-center gap-8 text-sm font-semibold transition-colors duration-500`}>
        ...
        <a 
  href="https://drive.google.com/file/d/1JD7eIPuj1jI1FCjeAD50S11Fv7J7YhuM/view?usp=sharing"             
  target="_blank"                
...
>
  ...
  { title: "Serverless Image Processing", link: "" },
  ...
  <motion.a
    ...
    // Added 'block' to className so the link works properly
    className={`block text-4xl md:text-7xl font-extrabold cursor-pointer transition-all duration-300 ${isDark ? "text-gray-300 hover:text-white" : "text-gray-800 hover:text-black"} hover:pl-4`}
  >
    {project.title}
  </motion.a>
))}
          ...
          <a 
            href="https://linkedin.com/in/shivamsingx" 
            target="_blank" 
            rel="noreferrer" 
      ...
      <main className="z-10 flex flex-col items-center text-center w-full max-w-5xl px-4">
...
>
    <span className="font-normal">I'm</span> Shivam
          ...
          <motion.div 
            ...
            className="flex items-center justify-center gap-3 text-3xl md:text-5xl font-semibold tracking-tight flex-wrap"
          >
            ...
            <motion.span 
              ...
              className="px-6 py-2 rounded-full bg-[#6ee786] text-black shadow-[0_0_20px_rgba(110,231,134,0.3)] cursor-default"
            >
              Frontend React dev.
            </motion.span>
          </motion.div>
  ...
  className="text-3xl md:text-5xl font-normal tracking-tight transition-colors duration-500 opacity-90"
>
            with an eye for{' '}
{/* CHANGED: span -> motion.span, added whileHover and cursor-pointer */}
<motion.span 
  className="relative inline-block px-1 z-10 cursor-pointer"
  
  // 1. Define the "Normal" state explicitly (No glow, normal scale)
  ...
  // 3. Make the transition snappy so it doesn't feel sticky
  transition={{ duration: 0.2 }}
>
   ...
   <span className="relative z-10 font-bold text-inherit">
     UI & Design
        ...
        <motion.div 
          ...
          className="mt-12 flex flex-wrap justify-center gap-8 md:gap-10 px-4 w-full max-w-4xl"
        >
          {/* Core */}
        ...
        <motion.div 
          ...
          className={`fixed bottom-10 flex items-center gap-6 px-8 py-4 ${theme.dock} backdrop-blur-xl border rounded-full shadow-2xl z-50`}
        >
          <DockIcon icon={<Github size={22} />} href="https://github.com/shivamsinghx" color={isDark ? "#ffffff" : "#000000"} label="GitHub" />
          <DockIcon icon={<Linkedin size={22} />} href="https://linkedin.com/in/shivamsingx" color="#0A66C2" label="LinkedIn" />
          <DockIcon icon={<SiX size={20} />} href="https://x.com/dudeitsokay_" color={isDark ? "#ffffff" : "#000000"} label="X" />
          
          <DockIcon icon={<SiDiscord size={22} />} href="https://discord.com/" color="#5865F2" label="Discord" />
          <DockIcon icon={<SiSteam size={22} />} href="https://steamcommunity.com/profiles/76561198980778931/" color={isDark ? "#66c0f4" : "#171a21"} label="Steam" />
...
const AvailabilityBadge = ({ isDark }) => (
  <motion.div
    ...
    className={`mt-16 z-40 px-4 py-1.5 rounded-full border flex items-center gap-2.5 shadow-sm backdrop-blur-md transition-colors duration-500 ${
       isDark ? "bg-[#111]/80 border-gray-800 text-gray-200" : "bg-white/90 border-gray-200 text-gray-700"
    }`}
  >
    <div className="relative flex h-2.5 w-2.5 items-center justify-center">
        {/* The Blinking Ping Effect */}
